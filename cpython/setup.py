...
class PyBuildExt(build_ext):
    ...
    def detect_modules(self):
        ...
        # It turns out to be that added GCC paths correspond to GCC which a
        # PYTHON_FOR_BUILD has been built with, not to the cross-compiler we
        # are being built with. Therefore, temporarely comment this out along
        # with multiarch_paths, which I've no notion about . . .
