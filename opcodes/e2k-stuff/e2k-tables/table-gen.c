...
struct cookie short_cookie =
  {
    ...
    {{&tables[0], "elbrus_v1_short_opers"},
     ...
     {&tables[6], "elbrus_v7_short_opers"}
    }
  };
...
struct cookie long_cookie =
  {
    7,
    {{&tables[7], "elbrus_v1_long_opers"},
     {&tables[8], "elbrus_v2_long_opers"},
     {&tables[9], "elbrus_v3_long_opers"},
     {&tables[10], "elbrus_v4_long_opers"},
     {&tables[11], "elbrus_v5_long_opers"},
     {&tables[12], "elbrus_v6_long_opers"},
     {&tables[13], "elbrus_v7_long_opers"}
    }
  };
...
struct cookie long_ext1_cookie =
  {
    5,
    {{&tables[14], "elbrus_v3_long_ext1_opers"},
     {&tables[15], "elbrus_v4_long_ext1_opers"},
     {&tables[16], "elbrus_v5_long_ext1_opers"},
     {&tables[17], "elbrus_v6_long_ext1_opers"},
     {&tables[18], "elbrus_v7_long_ext1_opers"}
    }
  };
...
struct cookie long_ext2_cookie =
  {
    2,
    {
      {&tables[19], "elbrus_v6_long_ext2_opers"},
      {&tables[20], "elbrus_v7_long_ext2_opers"}
    }
  };
