...
const struct target_desc *tdesc_sparcv932_linux;
static void
initialize_tdesc_sparcv932_linux (void)
{
  target_desc_up result = allocate_target_description ();
  set_tdesc_architecture (result.get (), bfd_scan_arch ("sparc:v8plus"));
  ...
  feature = tdesc_create_feature (result.get (), "org.mcst.gdb.sparc.v932");
  ...
  tdesc_sparcv932_linux = result.release ();
}
